...
{----------------------------------------------------------------------------------------------------------------------------------}
constructor TBaseConfiguration.Create(CreateOmitted : Boolean; AGlobalSettings : TBaseGlobalSettings; ALocalSettings : 
    TBaseLocalSettings; AStartupSettings : TBaseStartSettings; AUserPrefs : TBaseUserPreferences; AUserSettings : 
    TBaseUserSettings);
{{
