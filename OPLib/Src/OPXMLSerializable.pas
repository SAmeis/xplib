...
//ignora alertas para unit até definir-se sua continuidade
{$WARN UNSAFE_TYPE OFF} {$WARN UNSAFE_CODE OFF} {$WARN IMPLICIT_STRING_CAST OFF} {$WARN IMPLICIT_STRING_CAST_LOSS OFF}
...
begin
  ...
  Filter := [ { tkUnknown, } tkInteger, tkChar, tkEnumeration, tkFloat, tkString, tkSet, tkClass, { tkMethod, } tkWChar, tkLString,
