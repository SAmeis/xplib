...
type
	...
	published
		...
		property Units        : TTREUnits read FUnits;
	end;

	TTRELocalNetworks = TObjectList<TTRELocalNet>;

	TTRERegional = class(TTREUnits)
	private
		FLocalNetwork: TTRELocalNetworks;
		FDescription : string;
	...
	TTRECentralList = TObjectList<TTRECentral>;
...
begin
	Self.FCentralList := TTRECentralList.Create;
end;
...
begin
	inherited;
	Self.FLocalNetwork := TTRELocalNetworks.Create;
end;
