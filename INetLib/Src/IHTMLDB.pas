...
{$ENDIF}
{$I INetLib.inc}
//Diretivas antigas removidas desta versão
{ -$IFDEF IHTMLDB }
...
type
	...
	THTMLCellEvent = function(Sender: TObject; Field: TField; Cell: THTMLTableDetail): boolean of object;
	//Posto como funcao para indicar se a carga foi pre-feita
