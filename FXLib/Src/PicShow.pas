...

{
  ...
  This component is freeware and may be used in any software product (free or commercial) under the condition that I'm
  given proper credit (title, name and e-mail address in the documentation or the About box of the product this component
  is used in).
...
type
  ...
  TCustomDrawEvent = procedure(Sender: TObject; Picture, Screen: TBitmap; var UpdatedRgn: HRgn) of object;
...
// ----------------------------------------------------------------------------------------------------------------------
const
  AboutStr = '%s'#10#13 + 'by Kambiz R. Khojasteh'#10#13#10#13 + 'This componenet is freeware.'#10#13#10#13 +
	  'email: khojasteh@www.dci.co.ir'#10#13 + 'web: http://www.geocities.com/k_khojasteh/';
begin
  ...
  try
	...
	if not fStretch and Assigned(fBgPicture.Graphic) then begin
	  case fBgMode of
		...
		bmCentered: begin
			C.Draw((R.Right - R.Left - fBgPicture.Width) div 2, (R.Bottom - R.Top - fBgPicture.Height) div 2, fBgPicture.Graphic);
		  end;
	  end;
	end;
...
begin
  ...
  case fStyle of
	...
	85: begin
		...
		Rgn := CreateRoundRectRgn(X - W div 2, Y - H div 2, 3 * W div 2 - X, 3 * H div 2 - Y, 9 * (W - X) div 5, 9 * (H - Y) div 5);
