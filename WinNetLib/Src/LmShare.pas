...
type
	TNetShareAdd = function(servername: LPWSTR; level: DWORD; const buf: Pointer; parm_err: PDWORD): NET_API_STATUS; stdcall;

	TNetShareEnum = function(servername: LPWSTR; level: DWORD; var butptr: Pointer; prefmaxlen: DWORD; var entriesread: DWORD;
		var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall;

	TNetShareEnumSticky = function(servername: LPWSTR; level: DWORD; var butptr: Pointer; prefmaxlen: DWORD; var entriesread: DWORD;
		var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall;

	TNetShareGetInfo = function(servername: LPWSTR; netname: LPWSTR; level: DWORD; var butptr: Pointer): NET_API_STATUS; stdcall;

	TNetShareSetInfo = function(servername: LPWSTR; netname: LPWSTR; leve: DWORD; const buf: Pointer; parm_err: PDWORD)
		: NET_API_STATUS; stdcall;

	TNetShareDel = function(servername: LPWSTR; netname: LPWSTR; reserved: DWORD): NET_API_STATUS; stdcall;

	TNetShareDelSticky = function(servername: LPWSTR; netname: LPWSTR; reserved: DWORD): NET_API_STATUS; stdcall;

	TNetShareCheck = function(servername: LPWSTR; device: LPWSTR; var _type: DWORD): NET_API_STATUS; stdcall;
{$ELSE}
function NetShareAdd(servername: LPWSTR; level: DWORD; const buf: Pointer; parm_err: PDWORD): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetShareAdd}
function NetShareEnum(servername: LPWSTR; level: DWORD; var butptr: Pointer; prefmaxlen: DWORD; var entriesread: DWORD;
	var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetShareEnum}
function NetShareEnumSticky(servername: LPWSTR; level: DWORD; var butptr: Pointer; prefmaxlen: DWORD; var entriesread: DWORD;
	var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetShareEnumSticky}
function NetShareGetInfo(servername: LPWSTR; netname: LPWSTR; level: DWORD; var butptr: Pointer): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetShareGetInfo}
function NetShareSetInfo(servername: LPWSTR; netname: LPWSTR; leve: DWORD; const buf: Pointer; parm_err: PDWORD)
	: NET_API_STATUS; stdcall;
{$EXTERNALSYM NetShareSetInfo}
function NetShareDel(servername: LPWSTR; netname: LPWSTR; reserved: DWORD): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetShareDel}
function NetShareDelSticky(servername: LPWSTR; netname: LPWSTR; reserved: DWORD): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetShareDelSticky}
function NetShareCheck(servername: LPWSTR; device: LPWSTR; var _type: DWORD): NET_API_STATUS; stdcall;
...
type
	TNetSessionEnum = function(servername: LPWSTR; UncClientName: LPWSTR; username: LPWSTR; level: DWORD; var bufptr: Pointer;
		prefmaxlen: DWORD; var entriesread: DWORD; var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall;

	TNetSessionDel = function(servername: LPWSTR; UncClientName: LPWSTR; username: LPWSTR): NET_API_STATUS; stdcall;

	TNetSessionGetInfo = function(servername: LPWSTR; UncClientName: LPWSTR; username: LPWSTR; level: DWORD; var bufptr: Pointer)
		: NET_API_STATUS; stdcall;
	{$ELSE}
function NetSessionEnum(servername: LPWSTR; UncClientName: LPWSTR; username: LPWSTR; level: DWORD; var bufptr: Pointer;
	prefmaxlen: DWORD; var entriesread: DWORD; var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetSessionEnum}
function NetSessionDel(servername: LPWSTR; UncClientName: LPWSTR; username: LPWSTR): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetSessionDel}
function NetSessionGetInfo(servername: LPWSTR; UncClientName: LPWSTR; username: LPWSTR; level: DWORD; var bufptr: Pointer)
	: NET_API_STATUS; stdcall;
...
type
	TNetConnectionEnum = function(servername: LPWSTR; qualifier: LPWSTR; level: DWORD; var bufptr: Pointer; prefmaxlen: DWORD;
		var entriesread: DWORD; var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall;
	{$ELSE}
function NetConnectionEnum(servername: LPWSTR; qualifier: LPWSTR; level: DWORD; var bufptr: Pointer; prefmaxlen: DWORD;
	var entriesread: DWORD; var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall;
...
type
	...
	TNetFileEnum = function(servername: LPWSTR; basepath: LPWSTR; username: LPWSTR; level: DWORD; var bufptr: Pointer;
		prefmaxlen: DWORD; var entriesread: DWORD; var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall;

	TNetFileGetInfo = function(servername: LPWSTR; fileid: DWORD; level: DWORD; bufptr: Pointer): NET_API_STATUS; stdcall;
	{$ELSE}
function NetFileClose(servername: LPWSTR; fileid: DWORD): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetFileClose}
function NetFileEnum(servername: LPWSTR; basepath: LPWSTR; username: LPWSTR; level: DWORD; var bufptr: Pointer; prefmaxlen: DWORD;
	var entriesread: DWORD; var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetFileEnum}
function NetFileGetInfo(servername: LPWSTR; fileid: DWORD; level: DWORD; bufptr: Pointer): NET_API_STATUS; stdcall;
