...
function NetUserGetInfo(servername: LPCWSTR; username: LPCWSTR; level: DWORD; var bufptr: Pointer): NET_API_STATUS; stdcall;
...
function NetUserGetGroups(servername: LPCWSTR; username: LPCWSTR; level: DWORD; var bufptr: Pointer; prefmaxlen: DWORD;
	var entriesread: DWORD; var totalentries: DWORD): NET_API_STATUS; stdcall;

{$EXTERNALSYM NetUserSetGroups}
function NetUserSetGroups(servername: LPCWSTR; username: LPCWSTR; level: DWORD; buf: Pointer; num_entries: DWORD)
	: NET_API_STATUS; stdcall;
...
function NetUserModalsGet(servername: LPCWSTR; level: DWORD; var bufptr: Pointer): NET_API_STATUS; stdcall;

{$EXTERNALSYM NetUserModalsSet}
function NetUserModalsSet(servername: LPCWSTR; level: DWORD; buf: Pointer; parm_err: PDWORD): NET_API_STATUS; stdcall;
...
const
	...
	UF_ACCOUNT_TYPE_MASK = UF_TEMP_DUPLICATE_ACCOUNT or UF_NORMAL_ACCOUNT or UF_INTERDOMAIN_TRUST_ACCOUNT or
	...
	UF_SETTABLE_BITS = UF_SCRIPT or UF_ACCOUNTDISABLE or UF_LOCKOUT or UF_HOMEDIR_REQUIRED or UF_PASSWD_NOTREQD or
		UF_PASSWD_CANT_CHANGE or UF_ACCOUNT_TYPE_MASK or UF_DONT_EXPIRE_PASSWD or UF_MNS_LOGON_ACCOUNT or
		UF_ENCRYPTED_TEXT_PASSWORD_ALLOWED or UF_SMARTCARD_REQUIRED or UF_TRUSTED_FOR_DELEGATION or UF_NOT_DELEGATED or
		UF_USE_DES_KEY_ONLY or UF_DONT_REQUIRE_PREAUTH;
...
function NetGroupAdd(servername: LPCWSTR; level: DWORD; buf: Pointer; parm_err: PDWORD): NET_API_STATUS; stdcall;

{$EXTERNALSYM NetGroupAddUser}
function NetGroupAddUser(servername: LPCWSTR; GroupName: LPCWSTR; username: LPCWSTR): NET_API_STATUS; stdcall;

{$EXTERNALSYM NetGroupEnum}
function NetGroupEnum(servername: LPCWSTR; level: DWORD; var bufptr: Pointer; prefmaxlen: DWORD; var entriesread: DWORD;
	var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall;

{$EXTERNALSYM NetGroupGetInfo}
function NetGroupGetInfo(servername: LPCWSTR; GroupName: LPCWSTR; level: DWORD; var bufptr: Pointer): NET_API_STATUS; stdcall;

{$EXTERNALSYM NetGroupSetInfo}
function NetGroupSetInfo(servername: LPCWSTR; GroupName: LPCWSTR; level: DWORD; buf: Pointer; parm_err: PDWORD)
	: NET_API_STATUS; stdcall;
...
function NetGroupGetUsers(servername: LPCWSTR; GroupName: LPCWSTR; level: DWORD; var bufptr: Pointer; prefmaxlen: DWORD;
	var entriesread: DWORD; var totalentries: DWORD; ResumeHandle: PDWORD): NET_API_STATUS; stdcall;

{$EXTERNALSYM NetGroupSetUsers}
function NetGroupSetUsers(servername: LPCWSTR; GroupName: LPCWSTR; level: DWORD; buf: Pointer; totalentries: DWORD)
	: NET_API_STATUS; stdcall;
...
function NetLocalGroupAddMember(servername: LPCWSTR; GroupName: LPCWSTR; membersid: PSID): NET_API_STATUS; stdcall;

{$EXTERNALSYM NetLocalGroupEnum}
function NetLocalGroupEnum(servername: LPCWSTR; level: DWORD; var bufptr: Pointer; prefmaxlen: DWORD; var entriesread: DWORD;
	var totalentries: DWORD; ResumeHandle: PDWORD): NET_API_STATUS; stdcall;

{$EXTERNALSYM NetLocalGroupGetInfo}
function NetLocalGroupGetInfo(servername: LPCWSTR; GroupName: LPCWSTR; level: DWORD; var bufptr: Pointer): NET_API_STATUS; stdcall;

{$EXTERNALSYM NetLocalGroupSetInfo}
function NetLocalGroupSetInfo(servername: LPCWSTR; GroupName: LPCWSTR; level: DWORD; buf: Pointer; parm_err: PDWORD)
	: NET_API_STATUS; stdcall;
...
function NetLocalGroupGetMembers(servername: LPCWSTR; localgroupname: LPCWSTR; level: DWORD; var bufptr: Pointer; prefmaxlen: DWORD;
	var entriesread: DWORD; var totalentries: DWORD; ResumeHandle: PDWORD): NET_API_STATUS; stdcall;

{$EXTERNALSYM NetLocalGroupSetMembers}
function NetLocalGroupSetMembers(servername: LPCWSTR; GroupName: LPCWSTR; level: DWORD; buf: Pointer; totalentries: DWORD)
	: NET_API_STATUS; stdcall;

{$EXTERNALSYM NetLocalGroupAddMembers}
function NetLocalGroupAddMembers(servername: LPCWSTR; GroupName: LPCWSTR; level: DWORD; buf: Pointer; totalentries: DWORD)
	: NET_API_STATUS; stdcall;

{$EXTERNALSYM NetLocalGroupDelMembers}
function NetLocalGroupDelMembers(servername: LPCWSTR; GroupName: LPCWSTR; level: DWORD; buf: Pointer; totalentries: DWORD)
	: NET_API_STATUS; stdcall;
...
function NetQueryDisplayInformation(servername: LPCWSTR; level: DWORD; Index: DWORD; EntriesRequested: DWORD;
	PreferredMaximumLength: DWORD; var ReturnedEntryCount: DWORD; var SortedBuffer: Pointer): NET_API_STATUS; stdcall;

{$EXTERNALSYM NetGetDisplayInformationIndex}
function NetGetDisplayInformationIndex(servername: LPCWSTR; level: DWORD; Prefix: LPCWSTR; var Index: DWORD)
	: NET_API_STATUS; stdcall;
...
function NetAccessAdd(servername: LPCWSTR; level: DWORD; buf: Pointer; parm_err: PDWORD): NET_API_STATUS; stdcall;

//#define NetAccessEnum RxNetAccessEnum

{$EXTERNALSYM NetAccessEnum}
function NetAccessEnum(servername: LPCWSTR; BasePath: LPCWSTR; Recursive: DWORD; level: DWORD; bufptr: Pointer; prefmaxlen: DWORD;
	var entriesread: DWORD; var totalentries: DWORD; resume_handle: PDWORD): NET_API_STATUS; stdcall;

//#define NetAccessGetInfo RxNetAccessGetInfo

{$EXTERNALSYM NetAccessGetInfo}
function NetAccessGetInfo(servername: LPCWSTR; resource: LPCWSTR; level: DWORD; bufptr: Pointer): NET_API_STATUS; stdcall;

//#define NetAccessSetInfo RxNetAccessSetInfo

{$EXTERNALSYM NetAccessSetInfo}
function NetAccessSetInfo(servername: LPCWSTR; resource: LPCWSTR; level: DWORD; buf: Pointer; parm_err: PDWORD)
	: NET_API_STATUS; stdcall;
...
function NetAccessGetUserPerms(servername: LPCWSTR; UGname: LPCWSTR; resource: LPCWSTR; var Perms: DWORD): NET_API_STATUS; stdcall;
...
function NetGetDCName(servername: LPCWSTR; domainname: LPCWSTR; bufptr: Pointer): NET_API_STATUS; stdcall;

{$EXTERNALSYM NetGetAnyDCName}
function NetGetAnyDCName(servername: LPCWSTR; domainname: LPCWSTR; bufptr: Pointer): NET_API_STATUS; stdcall;

{$EXTERNALSYM I_NetLogonControl}
function I_NetLogonControl(servername: LPCWSTR; FunctionCode: DWORD; QueryLevel: DWORD; Buffer: Pointer): NET_API_STATUS; stdcall;

{$EXTERNALSYM I_NetLogonControl2}
function I_NetLogonControl2(servername: LPCWSTR; FunctionCode: DWORD; QueryLevel: DWORD; Data: Pointer; Buffer: Pointer)
	: NET_API_STATUS; stdcall;
...
//NOTE : if you change the following NETLOGON_CONTROL_* values, change them in net\svcdlls\logonsrv\logon.idl file also.
