...
function NetAlertRaise(AlertEventName: LPCWSTR; Buffer: Pointer; BufferSize: DWORD): NET_API_STATUS; stdcall;

{$EXTERNALSYM NetAlertRaiseEx}
function NetAlertRaiseEx(AlertEventName: LPCWSTR; VariableInfo: Pointer; VariableInfoSize: DWORD; ServiceName: LPCWSTR)
...
const
	...
	//It takes an alert structure and returns a pointer to structure beyond the standard portion.
...
//It takes a pointer to one of the other-info structs and returns a pointer to the variable data portion.
