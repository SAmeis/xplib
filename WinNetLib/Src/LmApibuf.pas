...
type
	...
	TNetApiBufferReallocate = function(OldBuffer: Pointer; NewByteCount: DWORD; var NewBuffer: Pointer): NET_API_STATUS; stdcall;
...
function NetApiBufferReallocate(OldBuffer: Pointer; NewByteCount: DWORD; var NewBuffer: Pointer): NET_API_STATUS; stdcall;
...
{$IFDEF LANMAN_DYNAMIC_LINK}
TNetapipBufferAllocate =
function(ByteCount: DWORD; var Buffer: Pointer): NET_API_STATUS; stdcall;
{$ELSE}
