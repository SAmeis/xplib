...
var
  ...
  _NetMessageNameGetInfo	: function ( servername: LPCWSTR; msgname: LPCWSTR; level: DWORD; var bufptr: Pointer): NET_API_STATUS; stdcall;
  _NetMessageNameDel		: function ( servername, msgname: LPCWSTR): NET_API_STATUS; stdcall;
  _NetMessageBufferSend	: function ( servername: LPCWSTR; msgname: LPCWSTR; fromname: LPCWSTR;
										 buf: Pointer; buflen: DWORD): NET_API_STATUS; stdcall;
...
function NetMessageBufferSend(servername: LPCWSTR; msgname: LPCWSTR; fromname: LPCWSTR; buf: Pointer; buflen: DWORD): NET_API_STATUS;
//----------------------------------------------------------------------------------------------------------------------
begin
