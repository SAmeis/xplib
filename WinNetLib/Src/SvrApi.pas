...
type
	TNetAccessAdd = function(const pszServer: LPSTR; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word): NET_API_STATUS; stdcall;

	TNetAccessCheck = function(pszReserved: LPSTR; pszUserName: LPSTR; pszResource: LPSTR; usOperation: Word; var pusResult: Word)
		: NET_API_STATUS; stdcall;

	TNetAccessDel = function(const pszServer: LPSTR; pszResource: LPSTR): NET_API_STATUS; stdcall;

	TNetAccessEnum = function(const pszServer: LPSTR; pszBasePath: LPSTR; fsRecursive: SmallInt; sLevel: SmallInt;
		pbBuffer: Pointer; cbBuffer: Word; var pcEntriesRead: Word; var pcTotalAvail: Word): NET_API_STATUS; stdcall;

	TNetAccessGetInfo = function(const pszServer: LPSTR; pszResource: LPSTR; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word;
		var pcTotalAvail: Word): NET_API_STATUS; stdcall;

	TNetAccessSetInfo = function(const pszServer: LPSTR; pszResource: LPSTR; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word;
		sParmNum: SmallInt): NET_API_STATUS; stdcall;

	TNetAccessGetUserPerms = function(const pszServer: LPSTR; pszUgName: LPSTR; pszResource: LPSTR; var pusPerms: SmallInt)
		: NET_API_STATUS; stdcall;
{$ELSE}
function NetAccessAdd(const pszServer: LPSTR; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetAccessAdd}
function NetAccessCheck(pszReserved: LPSTR; pszUserName: LPSTR; pszResource: LPSTR; usOperation: Word; var pusResult: Word)
	: NET_API_STATUS; stdcall;
...
function NetAccessEnum(const pszServer: LPSTR; pszBasePath: LPSTR; fsRecursive: SmallInt; sLevel: SmallInt; pbBuffer: Pointer;
	cbBuffer: Word; var pcEntriesRead: Word; var pcTotalAvail: Word): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetAccessEnum}
function NetAccessGetInfo(const pszServer: LPSTR; pszResource: LPSTR; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word;
	var pcTotalAvail: Word): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetAccessGetInfo}
function NetAccessSetInfo(const pszServer: LPSTR; pszResource: LPSTR; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word;
	sParmNum: SmallInt): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetAccessSetInfo}
function NetAccessGetUserPerms(const pszServer: LPSTR; pszUgName: LPSTR; pszResource: LPSTR; var pusPerms: SmallInt)
	: NET_API_STATUS; stdcall;
...
const
	...
	ACCESS_ALL = ACCESS_READ or ACCESS_WRITE or ACCESS_CREATE or ACCESS_EXEC or ACCESS_DELETE or ACCESS_ATRIB or ACCESS_PERM or
		ACCESS_FINDFIRST;
...
type
	TNetShareAdd = function(const pszServer: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word): NET_API_STATUS; stdcall;
	{$ELSE}
...
type
	TNetShareDel = function(const pszServer: PChar; const pszNetName: PChar; usReserved: Word): NET_API_STATUS; stdcall;
{$ELSE}
function NetShareDel(const pszServer: PChar; const pszNetName: PChar; usReserved: Word): NET_API_STATUS; stdcall;
...
type
	TNetShareEnum = function(const pszServer: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word; var pcEntriesRead: Word;
		var pcTotalAvail: Word): NET_API_STATUS; stdcall;
{$ELSE}
function NetShareEnum(const pszServer: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word; var pcEntriesRead: Word;
	var pcTotalAvail: Word): NET_API_STATUS; stdcall;
...
type
	TNetShareGetInfo = function(const pszServer: PChar; const pszNetName: PChar; sLevel: SmallInt; pbBuffer: Pointer;
		cbBuffer: Word; var pcTotalAvail: Word): NET_API_STATUS; stdcall;
{$ELSE}
function NetShareGetInfo(const pszServer: PChar; const pszNetName: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word;
	var pcTotalAvail: Word): NET_API_STATUS; stdcall;
...
type
	TNetShareSetInfo = function(const pszServer: PChar; const pszNetName: PChar; sLevel: SmallInt; pbBuffer: Pointer;
		cbBuffer: Word; sParmNum: Integer): NET_API_STATUS; stdcall;
{$ELSE}
function NetShareSetInfo(const pszServer: PChar; const pszNetName: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word;
...
type
	TNetSessionDel = function(const pszServer: PChar; const pszClientName: PChar; sReserved: SmallInt): NET_API_STATUS; stdcall;
	{$ELSE}
function NetSessionDel(const pszServer: PChar; const pszClientName: PChar; sReserved: SmallInt): NET_API_STATUS; stdcall;
...
type
	TNetSessionEnum = function(const pszServer: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word; var pcEntriesRead: Word;
		var pcTotalAvail: Word): NET_API_STATUS; stdcall;

	TNetSessionGetInfo = function(const pszServer: PChar; const pszClientName: PChar; sLevel: SmallInt; pbBuffer: Pointer;
		cbBuffer: Word; var pcTotalAvail: Word): NET_API_STATUS; stdcall;
{$ELSE}
function NetSessionEnum(const pszServer: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word; var pcEntriesRead: Word;
	var pcTotalAvail: Word): NET_API_STATUS; stdcall;
{$EXTERNALSYM NetSessionEnum}
function NetSessionGetInfo(const pszServer: PChar; const pszClientName: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word;
	var pcTotalAvail: Word): NET_API_STATUS; stdcall;
...
type
	TNetConnectionEnum = function(const pszServer: PChar; const pszQualifier: PChar; sLevel: SmallInt; pbBuffer: Pointer;
		cbBuffer: Word; var pcEntriesRead: Word; var pcTotalAvail: Word): NET_API_STATUS; stdcall;
	{$ELSE}
function NetConnectionEnum(const pszServer: PChar; const pszQualifier: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word;
...
type
	TNetFileEnum = function(const pszServer: PChar; const pszBasePath: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word;
		var pcEntriesRead: Word; var pcTotalAvail: Word): NET_API_STATUS; stdcall;
{$ELSE}
function NetFileEnum(const pszServer: PChar; const pszBasePath: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word;
	var pcEntriesRead: Word; var pcTotalAvail: Word): NET_API_STATUS; stdcall;
...
type
	TNetServerGetInfo = function(const pszServer: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word;
		var pcTotalAvail: Word): NET_API_STATUS; stdcall;
{$ELSE}
function NetServerGetInfo(const pszServer: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word; var pcTotalAvail: Word)
	: NET_API_STATUS; stdcall;
...
type
	TNetSecurityGetInfo = function(const pszServer: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word;
		var pcTotalAvail: Word): NET_API_STATUS; stdcall;
	{$ELSE}
function NetSecurityGetInfo(const pszServer: PChar; sLevel: SmallInt; pbBuffer: Pointer; cbBuffer: Word; var pcTotalAvail: Word)
	: NET_API_STATUS; stdcall;
