...
function I_BrowserServerEnum(servername, transport, clientname: LPCWSTR; level: DWORD; bufptr: Pointer; prefmaxlen: DWORD;
	var entriesread: DWORD; var totalentries: DWORD; servertype: DWORD; domain: LPCWSTR; resume_handle: PDWORD)
	: NET_API_STATUS; stdcall;
{$EXTERNALSYM I_BrowserServerEnum}
function I_BrowserServerEnumEx(servername, transport, clientname: LPCWSTR; level: DWORD; bufptr: Pointer; prefmaxlen: DWORD;
	var entriesread: DWORD; var totalentries: DWORD; servertype: DWORD; domain: LPCWSTR; FirstNameToReturn: LPCWSTR)
	: NET_API_STATUS; stdcall;
{$EXTERNALSYM I_BrowserServerEnumEx}
function I_BrowserQueryOtherDomains(servername: LPCWSTR; bufptr: Pointer; var entriesread: DWORD; var totalentries: DWORD)
	: NET_API_STATUS; stdcall;
...
function I_BrowserSetNetlogonState(servername, DomainName, EmulatedServerName: LPWSTR; Role: DWORD): NET_API_STATUS; stdcall;
...
function I_BrowserQueryEmulatedDomains(servername: LPWSTR; var EmulatedDomains: TBrowserEmulatedDomain; var entriesread: DWORD)
	: NET_API_STATUS; stdcall;
{$EXTERNALSYM I_BrowserQueryEmulatedDomains}
function I_BrowserQueryStatistics(servername: LPCWSTR; var statistics: TBrowserStatistics): NET_API_STATUS; stdcall;
...
function I_BrowserServerEnumForXactsrv(TransportName, clientname: LPCWSTR; NtLevel: ULONG; ClientLevel: Word; Buffer: Pointer;
	BufferLength: Word; PreferedMaximumLength: DWORD; var entriesread: DWORD; var totalentries: DWORD; servertype: DWORD;
	domain: LPCWSTR; FirstNameToReturn: LPCWSTR; Converter: PWord): Word; stdcall;
