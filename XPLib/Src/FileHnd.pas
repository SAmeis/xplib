...
type
	...
	public
		...
		///<param name="V1">1 componente da versão</param> <param name="V2">2 componente da versão</param>
		///<param name="V3">3 componente da versão</param> <param name="V4">4 componente da versão</param>
		///<remarks>
		...
		///<summary>
		///Retorna caminho completo após expansão relativa de BasePath em Path
		///</summary>
		...
		///</summary>
		///<param name="OriginalName">nome informado(geralmente pelo usuário)</param>
		///<param name="DesiredExtension">extensão desejada</param>
		///<returns>Nome completo com a extensão desejada</returns>
		///<remarks>
		///Ver também:
