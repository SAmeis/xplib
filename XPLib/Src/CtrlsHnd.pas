...
uses
  Forms, Math, WinReg32, Str_Pas, IniFiles, Printers, Contnrs, System.Generics.Collections;
	...
	if FUnique then begin
	  case CharCase of
		...
		ecLowerCase: begin
		  ...
		  raise Exception.Create('Condição anormal para classe: ' + Self.ClassName);
		end;
	  end;
