...
const
    ...
    BR_PROVINCES_NAME_CODE: array[0..26] of array[0..1] of string = (
        (BR_PROV_NAME_ACRE, BR_PROV_CODE_ACRE),
        (BR_PROV_NAME_ALAGOAS, BR_PROV_CODE_ALAGOAS),
        (BR_PROV_NAME_AMAPA, BR_PROV_CODE_AMAPA),
        (BR_PROV_NAME_AMAZONAS, BR_PROV_CODE_AMAZONAS),
        (BR_PROV_NAME_BAHIA, BR_PROV_CODE_BAHIA),
        (BR_PROV_NAME_CEARA, BR_PROV_CODE_CEARA),
        (BR_PROV_NAME_DISTRITO_FEDERAL, BR_PROV_CODE_DISTRITO_FEDERAL),
        (BR_PROV_NAME_ESPIRITO_SANTO, BR_PROV_CODE_ESPIRITO_SANTO),
        (BR_PROV_NAME_GOIAS, BR_PROV_CODE_GOIAS),
        (BR_PROV_NAME_MARANHAO, BR_PROV_CODE_MARANHAO),
        (BR_PROV_NAME_MATO_GROSSO, BR_PROV_CODE_MATO_GROSSO),
        (BR_PROV_NAME_MATO_GROSSO_DO_SUL, BR_PROV_CODE_MATO_GROSSO_DO_SUL),
        (BR_PROV_NAME_MINAS_GERAIS, BR_PROV_CODE_MINAS_GERAIS),
        (BR_PROV_NAME_PARA, BR_PROV_CODE_PARA),
        (BR_PROV_NAME_PARAIBA, BR_PROV_CODE_PARAIBA),
        (BR_PROV_NAME_PARANA, BR_PROV_CODE_PARANA),
        (BR_PROV_NAME_PERNAMBUCO, BR_PROV_CODE_PERNAMBUCO),
        (BR_PROV_NAME_PIAUI, BR_PROV_CODE_PIAUI),
        (BR_PROV_NAME_RIO_DE_JANEIRO, BR_PROV_CODE_RIO_DE_JANEIRO),
        (BR_PROV_NAME_RIO_GRANDE_DO_NORTE, BR_PROV_CODE_RIO_GRANDE_DO_NORTE),
        (BR_PROV_NAME_RIO_GRANDE_DO_SUL, BR_PROV_CODE_RIO_GRANDE_DO_SUL),
        (BR_PROV_NAME_RONDONIA, BR_PROV_CODE_RONDONIA),
        (BR_PROV_NAME_RORAIMA, BR_PROV_CODE_RORAIMA),
        (BR_PROV_NAME_SANTA_CATARINA, BR_PROV_CODE_SANTA_CATARINA),
        (BR_PROV_NAME_SAO_PAULO, BR_PROV_CODE_SAO_PAULO),
        (BR_PROV_NAME_SERGIPE, BR_PROV_CODE_SERGIPE),
        (BR_PROV_NAME_TOCANTINS, BR_PROV_CODE_TOCANTINS)
        );

    BR_PROVINCES_CODE_NAME: array[0..26] of array[0..1] of string = (
        (BR_PROV_NAME_ACRE, BR_PROV_CODE_ACRE), //AC
...
begin
    ...
    if (mCGC = EmptyStr) then begin
        ...
        Tot  := ((StrToInt(mCGC[1]) + StrToInt(mCGC[9])) * 5) +
            ((StrToInt(mCGC[2]) + StrToInt(mCGC[10])) * 4) +
            ((StrToInt(mCGC[3]) + StrToInt(mCGC[11])) * 3) +
            ((StrToInt(mCGC[4]) + StrToInt(mCGC[12])) * 2) +
            ((StrToInt(mCGC[5]) * 9) + (StrToInt(mCGC[6]) * 8)) +
            ((StrToInt(mCGC[7]) * 7) + (StrToInt(mCGC[8]) * 6));
        ...
        Tot := ((StrToInt(mCGC[1]) + StrToInt(mCGC[9])) * 6) +
            ((StrToInt(mCGC[2]) + StrToInt(mCGC[10])) * 5) +
            ((StrToInt(mCGC[3]) + StrToInt(mCGC[11])) * 4) +
            ((StrToInt(mCGC[4]) + StrToInt(mCGC[12])) * 3) +
            ((StrToInt(mCGC[5]) + StrToInt(mDigito1)) * 2) +
            ((StrToInt(mCGC[6]) * 9) + (StrToInt(mCGC[7]) * 8)) +
            ((StrToInt(mCGC[8]) * 7));
...
const
    _TOKEN_ = '@';
    _PROVINCE_NAMES_ = _TOKEN_ + BR_PROV_NAME_ACRE +
        _TOKEN_ + BR_PROV_NAME_ALAGOAS +
        _TOKEN_ + BR_PROV_NAME_AMAPA +
        _TOKEN_ + BR_PROV_NAME_AMAZONAS +
        _TOKEN_ + BR_PROV_NAME_BAHIA +
        _TOKEN_ + BR_PROV_NAME_CEARA +
        _TOKEN_ + BR_PROV_NAME_DISTRITO_FEDERAL +
        _TOKEN_ + BR_PROV_NAME_ESPIRITO_SANTO +
        _TOKEN_ + BR_PROV_NAME_GOIAS +
        _TOKEN_ + BR_PROV_NAME_MARANHAO +
        _TOKEN_ + BR_PROV_NAME_MATO_GROSSO +
        _TOKEN_ + BR_PROV_NAME_MATO_GROSSO_DO_SUL +
        _TOKEN_ + BR_PROV_NAME_MINAS_GERAIS +
        _TOKEN_ + BR_PROV_NAME_PARA +
        _TOKEN_ + BR_PROV_NAME_PARAIBA +
        _TOKEN_ + BR_PROV_NAME_PARANA +
        _TOKEN_ + BR_PROV_NAME_PERNAMBUCO +
        _TOKEN_ + BR_PROV_NAME_PIAUI +
        _TOKEN_ + BR_PROV_NAME_RIO_DE_JANEIRO +
        _TOKEN_ + BR_PROV_NAME_RIO_GRANDE_DO_NORTE +
        _TOKEN_ + BR_PROV_NAME_RIO_GRANDE_DO_SUL +
        _TOKEN_ + BR_PROV_NAME_RONDONIA +
        _TOKEN_ + BR_PROV_NAME_RORAIMA +
        _TOKEN_ + BR_PROV_NAME_SANTA_CATARINA +
        _TOKEN_ + BR_PROV_NAME_SAO_PAULO +
        _TOKEN_ + BR_PROV_NAME_SERGIPE +
        _TOKEN_ + BR_PROV_NAME_TOCANTINS;
var
...
const
    _TOKEN_ = '@';
    _PROVINCES_CODES_ = _TOKEN_ + BR_PROV_CODE_ACRE +
        _TOKEN_ + BR_PROV_CODE_ALAGOAS +
        _TOKEN_ + BR_PROV_CODE_AMAZONAS +
        _TOKEN_ + BR_PROV_CODE_AMAPA +
        _TOKEN_ + BR_PROV_CODE_BAHIA +
        _TOKEN_ + BR_PROV_CODE_CEARA +
        _TOKEN_ + BR_PROV_CODE_DISTRITO_FEDERAL +
        _TOKEN_ + BR_PROV_CODE_ESPIRITO_SANTO +
        _TOKEN_ + BR_PROV_CODE_GOIAS +
        _TOKEN_ + BR_PROV_CODE_MARANHAO +
        _TOKEN_ + BR_PROV_CODE_MINAS_GERAIS +
        _TOKEN_ + BR_PROV_CODE_MATO_GROSSO_DO_SUL +
        _TOKEN_ + BR_PROV_CODE_MATO_GROSSO +
        _TOKEN_ + BR_PROV_CODE_PARA +
        _TOKEN_ + BR_PROV_CODE_PARAIBA +
        _TOKEN_ + BR_PROV_CODE_PERNAMBUCO +
        _TOKEN_ + BR_PROV_CODE_PIAUI +
        _TOKEN_ + BR_PROV_CODE_PARANA +
        _TOKEN_ + BR_PROV_CODE_RIO_DE_JANEIRO +
        _TOKEN_ + BR_PROV_CODE_RIO_GRANDE_DO_NORTE +
        _TOKEN_ + BR_PROV_CODE_RONDONIA +
        _TOKEN_ + BR_PROV_CODE_RORAIMA +
        _TOKEN_ + BR_PROV_CODE_RIO_GRANDE_DO_SUL +
        _TOKEN_ + BR_PROV_CODE_SANTA_CATARINA +
        _TOKEN_ + BR_PROV_CODE_SERGIPE +
        _TOKEN_ + BR_PROV_CODE_SAO_PAULO +
        _TOKEN_ + BR_PROV_CODE_TOCANTINS;
var
    SearchString, Pattern : string;
    p : integer;
