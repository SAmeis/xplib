...
begin
	inherited;
	{ TODO -oRoger -cLIB : Para melhor controle podemos ler a pilha de mensagens e
	  descobrir que dos items foi selecionado e criar novo evento informando-o }
	if Assigned(Self.OnCloseMenu) then begin //Identifica qual foi selecionado
		SelectedItem := nil;
		if PeekMessage(Msg, 0 { ??? * } , 0, 0, PM_NOREMOVE) then begin
			// ***Nao consegui identificar que P... de janela era a certa -> pegar todas
