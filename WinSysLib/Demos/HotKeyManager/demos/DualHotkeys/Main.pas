...
uses
    ...
    ComCtrls, WinHotKey, JvComponentBase, JvAppHotKey;
...
type
    TMainForm = class(TForm)
        ...
        Label3 :         TLabel;
    jvhtky1: TJvApplicationHotKey;
        procedure FormCreate(Sender : TObject);
        procedure Button1Click(Sender : TObject);
        procedure Button2Click(Sender : TObject);
        procedure Button3Click(Sender : TObject);
        procedure HotKeyManager1HotKeyPressed(HotKey : cardinal; Index : Word);
    procedure jvhtky1HotKeyRegisterFailed(Sender: TObject; var HotKey: TShortCut);
    procedure jvhtky1HotKey(Sender: TObject);
    private
...
procedure TMainForm.jvhtky1HotKey(Sender: TObject);
begin
MessageBoxW(0, 'atalho jedi pressionado', PWideChar(Error), MB_OK +
  MB_ICONSTOP + MB_TOPMOST);
end;

procedure TMainForm.jvhtky1HotKeyRegisterFailed(Sender: TObject; var HotKey: TShortCut);
begin
	MessageBoxW(0, 'registro falhou', PWideChar(Error), MB_OK + MB_ICONSTOP +
     MB_TOPMOST);
end;
