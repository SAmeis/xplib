...
uses
    Windows, Classes, SvcMgr, WinHotKey;
                ...
                if (QueryServiceStatus(h_svc, ServiceStatus)) then begin
                    while (SERVICE_STOPPED <> ServiceStatus.dwCurrentState) do begin
                        ...
                        Sleep(ServiceStatus.dwWaitHint);
						 if (not QueryServiceStatus(h_svc, ServiceStatus)) then begin// couldn't check status
							 break;
						 end;
                        if (ServiceStatus.dwCheckPoint < dwCheckPoint) then begin
                            Break;
                        end;
                    end;
                end;
