...
type
    ...
    TFindPreviousInstanceEvent = procedure(SiblingAppHandle, PipeWndHandle : THandle; cmdLine : string;
        var ContinueScan : boolean; var TerminateSelf : boolean) of object;
...
begin
    ...
    if FMutexHandle <> 0 then begin //Consegui criar o Mutex, averiguar sua unicidade agora, usando GetLastError para isso
        if Ret = ERROR_ALREADY_EXISTS then begin //Ha outro alem deste
            ...
            EnumWindows(@EnumWindowsFunc, longint(Self));
        end;
